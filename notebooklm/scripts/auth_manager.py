...
class AuthManager:
    ...
    def setup_auth(self, headless: bool = False, timeout_minutes: int = 10) -> bool:
        ...
        print("  Using standard browser context (non-persistent) for clean login...")
        ...
        try:
            ...
            # Use a regular browser launch (NOT persistent context)
            # This avoids the corrupted profile / cookie-blocking issue
            ...
            if "notebooklm.google.com" in page.url and "accounts.google.com" not in page.url:
                ...
                self._save_context_state(context)
                return True
    ...
    def _save_context_state(self, context):
