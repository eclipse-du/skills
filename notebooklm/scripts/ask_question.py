...
def ask_notebooklm(question: str, notebook_url: str, headless: bool = True) -> str:
    ...
    try:
        ...
        page.goto(notebook_url, wait_until="commit")
        ...
        try:
            ...
            print(f"  ⚠️ Timeout waiting for URL pattern. Current: {page.url}")
            if "accounts.google.com" in page.url:
                print("  ❌ Redirected to login page. Session state likely invalid or expired.")
                return "Error: Session expired. Please re-export state.json."
